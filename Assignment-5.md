...
You should also take a look at [our guide for organizing your code with packages](Organizing-your-code-with-packages.md) for understanding what should be the full structure of your project.
...
For this assignment we will use this [build.xml](code/ass5/build.xml).
